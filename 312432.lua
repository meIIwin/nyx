...
Nyx.Items = Menu.AddKeyOption{"Hero Specific", "Nyx Assassin"} "Артефакты в комбо", false)
Nyx.Skill = Menu.AddKeyOption{"Hero Specific", "Nyx Assassin"} "Скилы в комбо". false)
