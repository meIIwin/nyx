...
Nyx.Items = Menu.AddOptionBool{"Hero Specific", "Nyx Assassin"} "Артефакты в комбо", false)
Nyx.Skill = Menu.AddOptionBool{"Hero Specific", "Nyx Assassin"} "Скилы в комбо". false)
